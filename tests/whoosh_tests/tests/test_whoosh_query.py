...
class WhooshSearchQueryTestCase(TestCase):
    ...
    def test_build_query_multiple_filter_types(self):
        ...
        self.assertEqual(self.sq.build_query(), '((why) AND pub_date:([to 20090210015900]) AND author:({daniel to}) AND created:({to 20090212121300}) AND title:([B to]) AND id:(1 OR 2 OR 3) AND rating:([3 to 5]))')
